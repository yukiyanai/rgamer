...
The functions prepared by the package not only solve basic games such as two-person normal-form games but also provide the users with visual displays that highlight some aspects of the game---payoff matrix, best response correspondence, etc.
