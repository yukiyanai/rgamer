...
The functions provided by the package not only solve basic games such as two-person normal-form games but also provides the users with visual displays that highlight some aspects of the games --- payoff matrix, best response correspondence, etc.
